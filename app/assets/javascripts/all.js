...
var Layout = function () {
	...
	function init () {
		...
		$('#advancedSearchTrigger').bind ('click', advancedClick);
...
var Menu = function () {
	...
	function init (config) {	
		...
		$menuContainer.find ('form').bind ('submit', function (e) { e.preventDefault (); });
	}
...
(function($) {
    ...
    $.fn.tipsy = function(options) {
        ...
        if (!options.bind) this.each(function() { get(this); });
        
        if (options.trigger != 'manual') {
            var binder   = options.bind ? 'live' : 'bind',
...
$(function () {
	...
	$('.widget-tabs').find ('.tabs a').bind('click', tabClick);
...
$(function () {			   
	...
	$('#reveal-nav').bind ('click', toggleNav);
	
	$('.notify').find ('.close').bind ('click', notifyClose);
